...
class BackupCompanionDraggablePatientList extends StatelessWidget {
  const BackupCompanionDraggablePatientList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Patient>>(
      stream:
          PatientDataController.instance.getPatientsStreamFromBackupCompanion(),
            ...
            return ValueListenableBuilder<Patient?>(
              ...
              builder: (context, updatedPatient, child) {
                ...
                return PatientCardSmall(
                  ...
                  onLocate: () => LocationService.instance.locatePatient(
                      backupCompanionHomeScreenState, updatedPatient),
                  onCall: () {
                    // Call functionality
                  },
                  onTap: () {
                    backupCompanionHomeScreenState.scrollableController
                        .animateTo(0.06,
                      ...
                      backupCompanionHomeScreenState.setShowFloatingCard(true);
                      backupCompanionHomeScreenState.setShowCloseIcon(true);
                    });
                  },
                );
              },
